...
subroutine vertvisc(u, v, h, forces, visc, dt, OBC, ADp, CDp, G, GV, US, CS, &
  ...
  do j=G%jsc,G%jec
    ...
    do I=Isq,Ieq ; if (do_i(I)) then
      ...
      b_denom_1 = CS%h_u(I,j,1) + dt * (ray_mean + CS%a_u(I,j,1))
    ...
    do k=2,4 ; do I=Isq,Ieq ; if (do_i(I)) then
      ...
      b_denom_1 = CS%h_u(I,j,k) + dt * (ray_mean + CS%a_u(I,j,K)*d1(I))
  ...
  do J=Jsq,Jeq
    ...
    do i=is,ie ; if (do_i(i)) then
      ...
      b_denom_1 = CS%h_v(i,J,1) + dt * (ray_mean + CS%a_v(i,J,1))
    ...
    do k=2,4 ; do i=is,ie ; if (do_i(i)) then
      ...
      b_denom_1 = CS%h_v(i,J,k) + dt * (ray_mean + CS%a_v(i,J,K)*d1(i))
